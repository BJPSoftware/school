												...
												<fieldset>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															...
															<input id="loginEmail" name="userName" type="text" class="form-control" placeholder="账号" />
													...
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input id="loginPassword" name="userPwd" type="password" class="form-control" placeholder="密码" />
